...
public class SparkParquetWriters {
  ...
  private static class GeometryWKBWriter
    ...
    public GeometryWKBWriter(ColumnDescriptor desc) {
      super(desc);
    }
  ...
  private static class GeometryWKBBBoxWriter
    ...
    public GeometryWKBBBoxWriter(MessageType type, String[] prefix) {
      super(type, prefix);
    }
  ...
  private static class GeometryNestedListWriter
    ...
    public GeometryNestedListWriter(MessageType type, String[] prefix) {
      super(type, prefix);
    }
